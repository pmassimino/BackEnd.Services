...
namespace BackEnd.Api.Controllers.Contable
{
    ...
    [ApiController]
    public class ComprobanteMayorController : ApiController<ComprobanteMayor, string>
    {
        public ComprobanteMayorController(IComprobanteMayorService service, IAuthService authService) : base(service, authService)
        {           
        }
