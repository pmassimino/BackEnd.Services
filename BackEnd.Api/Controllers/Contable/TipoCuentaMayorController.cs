...
namespace BackEnd.Api.Controllers.Contable
{
    ...
    [ApiController]
    public class TipoCuentaMayorController : ApiController<TipoCuentaMayor, string>
    {
        public TipoCuentaMayorController(ITipoCuentaMayorService service, IAuthService authService) : base(service, authService)
        {           
        }
