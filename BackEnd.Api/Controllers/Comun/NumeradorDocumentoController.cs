...
namespace BackEnd.Api.Controllers.Comun
{
    ...
    [ApiController]
    public class NumeradorDocumentoController : ApiController<NumeradorDocumento, string>
    {
        public NumeradorDocumentoController(INumeradorDocumentoService service, IAuthService authService) : base(service, authService)
        {           
        }
